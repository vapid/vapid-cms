...
function ifHelper(input, input2, input3) {
  const value = (typeof input === 'function') ? input() : input;
  const options = input2 || {};
  if (!options.fn) {
    const ifValue = (typeof input2 === 'function') ? input2() : input2;
    const elseValue = (typeof input3 === 'function') ? input3() : input3;
    return input ? ifValue : elseValue;
  }
...
function unlessHelper(input, ...args) {
  const value = (typeof input === 'function') ? input() : input;
  return ifHelper.call(this, !value, ...args);
}
...
function missingData(context = {}, options = {}) {
  console.log(options);
